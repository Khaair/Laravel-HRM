        ...
        <div class="card card-xl-stretch mb-5 mb-xl-8">
            ...
            <div class="card-header border-0 pt-5">
                ...
                <div href="#" class="card-toolbar" class="card-toolbar" data-bs-toggle="tooltip" data-bs-placement="top"
                    ...
                    <a href="{{ route('attendances.create') }}" class="btn btn-sm btn-light btn-active-primary">
                    ...
                    <table class="table table-row-dashed table-row-gray-300 align-middle gs-0 gy-4">
                        ...
                        <thead>
                            <tr class="fw-bolder text-muted">
                                ...
                                <th class="min-w-120px">Clock In</th>
                                <th class="min-w-120px">Clock Out</th>
                            ...
                            <tr>
                                <td>
                                    <a href="#" class="text-dark fw-bolder text-hover-primary d-block fs-6">
                                        {{ $attendance->employee->title ?? 'No Employee Assigned' }}
                                    </a>
                                ...
                                <td>
                                    <a href="#" class="text-dark fw-bolder text-hover-primary d-block fs-6">
                                        ...
                                        <small> {{ $attendance->clock_in ?? 'N/A' }}</small>
                                    </a>
                                ...
                                <td>
                                    <a href="#" class="text-dark fw-bolder text-hover-primary d-block fs-6">
                                        ...
                                        <small>{{ $attendance->clock_out ?? 'N/A' }}</small>
                                    </a>
